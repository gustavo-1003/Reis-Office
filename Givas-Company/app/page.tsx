          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-md-4">        <div className="col-md-2 d-flex justify-content-center">
                <img
                  src="https://media.licdn.com/dms/image/v2/C4D0BAQEBO9IGuXPhRA/company-logo_200_200/company-logo_200_200/0/1657658606533/reisoffice_logo?e=2147483647&v=beta&t=niA1_cCEHiS8ML_8dD9uX4xt_HCsz_vc-QGZXjH4oHY"
                  alt="Equipe de RH trabalhando com tecnologia e automação"
            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-5 animate-fade-right">
                <div className="text-end">
                  <img
                    src="/placeholder.svg?height=400&width=500&text=Equipe+RH+Tecnologia"
                    alt="Equipe de RH trabalhando com tecnologia e automação"
                    className="img-fluid rounded shadow-lg"
